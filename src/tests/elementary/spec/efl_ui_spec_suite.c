...
_test_efl_ui_item_container_grid_efl_object_constructor(Eo *obj, void *pd EINA_UNUSED)
{
   efl_constructor(efl_super(obj, TEST_EFL_UI_ITEM_CONTAINER_GRID_CLASS));
...
#include "test_efl_ui_item_container_grid.eo.c"
